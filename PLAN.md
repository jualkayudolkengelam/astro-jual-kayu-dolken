...
> Diperbarui 24 Agosto 2026 · Repo publik astro-jual-kayu-dolken · Live: Vercel (auto-deploy dari push)
>

## Keputusan Desain (hasil diskusi 24 Agustus 2026)
...
## Fakta Pendukung (hasil investigasi 24 Agustus 2026)
...
- Kredensial push GitHub tertanum di remote origin (dipasang pemilik situs)

## A. Fondasi Konten Per-Kota ✅ (24 Agosto)
1. [x] Pecah konten kota → src/data/konten-kota/{slug}.json
2. [x] dates.js & sitemap lastmod per-file git

## A+. Konteks Lokal Bertumbuh ✅ desain disepakati 24 Agustus
...
2. [ ] Seed artikel awal (dibuat manual berkualitas, bukan hasil bot):
       ...
       - Merawat Kayu Dolken agar Awat Puluhan Tahun
...
5. [ ] Set SITE_URL=https://www.jualdolkenkayu.com saat domain produksi terpasang

## D. Menyusul (backlog)
- [ ] Verifikasi Search Console + submit sitemap-index.xml (menunggu domain)
- [ ] Set SITE_URL=https://www.jualdolkenkayu.com saat domain produksi terpasang
